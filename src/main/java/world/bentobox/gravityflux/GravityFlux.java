...
import world.bentobox.gravityflux.generators.GFGenerator;

/**
 * Main class - provides a survival game with flipping gravity
 * @author tastybento
 */
public class GravityFlux extends GameModeAddon {
    ...
    private GFGenerator chunkGenerator;
    ...
    public void onLoad() {
        ...
        // Chunk generator
        chunkGenerator = settings.isUseOwnGenerator() ? null : new GFGenerator(this);
    ...
    private boolean loadSettings() {
        ...
        if (settings == null) {
            // Disable
            logError("GF settings could not load! Addon disabled.");
    ...
    public void onEnable() {
        ...
        // Register listeners
        this.registerListener(chunkGenerator);
     ...
     */
    private World getWorld(String worldName2, Environment env, GFGenerator chunkGenerator2) {
        // Set world name
