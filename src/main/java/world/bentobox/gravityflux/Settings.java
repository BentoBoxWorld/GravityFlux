...
public class Settings implements WorldSettings {
    ...
    @ConfigEntry(path = "gravityflux.command.island")
    private String playerCommandAliases = "island is skyblock sb";

    @ConfigComment("The island admin command.")
    @ConfigComment("To define alias, just separate commands with white space.")
    @ConfigEntry(path = "gravityflux.command.admin")
    private String adminCommandAliases = "gfadmin gfa skyblockadmin sbadmin sba";
    ...
    @ConfigEntry(path = "gravityflux.command.new-player-action")
    ...
    @ConfigEntry(path = "gravityflux.command.default-action")
    private String defaultPlayerAction = "go";

    /*      WORLD       */
    @ConfigComment("Friendly name for this world. Used in admin commands. Must be a single word")
    @ConfigEntry(path = "world.friendly-name")
    private String friendlyName = "GravityFlux";

    @ConfigComment("Name of the world - if it does not exist then it will be generated.")
    @ConfigComment("It acts like a prefix for nether and end (e.g. gravityflux_world, gravityflux_world_nether, gravityflux_world_end)")
    @ConfigEntry(path = "world.world-name")
    private String worldName = "gravityflux_world";
    ...
    @ConfigComment("or set this permission: gravityflux.island.range.<number>")
    ...
    @ConfigComment("Players can have the gravityflux.coop.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("Players can have the gravityflux.trust.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("GravityFlux blocked mobs.")
    @ConfigComment("List of mobs that should not spawn in GravityFlux.")
